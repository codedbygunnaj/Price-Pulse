...
t.exports)
  ...
  , c = (n, r, o) => (o = n == null ? {} : e(i(n)),
s(r || !n || !n.__esModule || !a.call(n, `default`) ? t(o, `default`, {
    value: n,
    enumerable: !0
}) : o, n));
(function() {
...
var l = o((e => {
    var t = Symbol.for(`react.transitional.element`)
      ...
      , m = Symbol.iterator;
    function h(e) {
        return typeof e != `object` || !e ? null : (e = m && e[m] || e[`@@iterator`],
    ...
    function se(e) {
        ...
        case `rejected`:
            throw e.reason;
        default:
            switch (typeof e.status == `string` ? e.then(ne, ne) : (e.status = `pending`,
            e.then(function(t) {
    ...
    function ce(e, r, i, a, o) {
        ...
        if (c)
            ...
            ce(o, r, i, ``, function(e) {
                return e
            })) : o != null && (T(o) && (o = w(o, i + (o.key == null || e && e.key === o.key ? `` : (`` + o.key).replace(ae, `$&/`) + `/`) + c)),
            r.push(o)),
            1;
        c = 0;
        var l = a === `` ? `.` : a + `:`;
    ...
    function ue(e) {
        if (e._status === -1) {
            ...
            n.then(function(t) {
                ...
                e._result = t,
                n.status === void 0 && (n.status = `fulfilled`,
                n.value = t))
            }, function(t) {
                (e._status === 0 || e._status === -1) && (e._status = 2,
                e._result = t,
                n.status === void 0 && (n.status = `rejected`,
                n.reason = t))
            }),
    ...
    function fe(e) {
        var t = S.T
          , n = {};
        n.types = t === null ? null : t.types,
        S.T = n;
        try {
            var r = e()
              , i = S.S;
            i !== null && i(n, r),
            typeof r == `object` && r && typeof r.then == `function` && r.then(ne, de)
        } catch (e) {
            de(e)
        } finally {
    ...
    e.cloneElement = function(e, t, n) {
        ...
        if (t != null)
            ...
            t)
                !re.call(t, a) || a === `key` || a === `__self` || a === `__source` || a === `ref` && t.ref === void 0 || (r[a] = t[a]);
    ...
    e.createElement = function(e, t, n) {
        ...
        if (t != null)
            ...
            t)
                re.call(t, r) && r !== `key` && r !== `__self` && r !== `__source` && (i[r] = t[r]);
  ...
  , h = o((e => {
    ...
    function h(e, t, n, r, i, a) {
        for (; e !== null; ) {
            if ((e.tag === 5 || e.tag === 27 || e.tag === 6) && n(e, r, i, a) || (e.tag !== 22 || e.memoizedState === null) && (t || e.tag !== 5 && e.tag !== 27) && h(e.child, t, n, r, i, a))
                return !0;
            e = e.sibling
        }
        return !1
        ...
        for (; n !== null; ) {
            if (n === t)
                ...
                if (r.foundSelf)
                    ...
                    !0;
                e[0] = n
            } else if ((n.tag !== 22 || n.memoizedState === null) && y(e, t, n.child, r))
                return !0;
            n = n.sibling
        }
        return !1
    ...
    var C = Object.assign
      ...
      , ge = Symbol.for(`react.legacy_hidden`)
      , _e = Symbol.for(`react.memo_cache_sentinel`)
      , ve = Symbol.for(`react.view_transition`)
      , ye = Symbol.for(`react.recoverable`)
      , be = Symbol.iterator;
    function xe(e) {
        return typeof e != `object` || !e ? null : (e = be && e[be] || e[`@@iterator`],
        typeof e == `function` ? e : null)
    }
    ...
    function Fe(e) {
        var t = e.memoizedState;
        t !== null && (sh._currentValue = t.memoizedState,
        k(Me, e)),
        t = ke.current;
        var n = dp(t, e.type);
        t !== n && (k(Ae, e),
...
` + e.stack
    ...
    function mt(e, t, n) {
        ...
        return s === 0 ? (s = r & ~a,
        s === 0 ? o === 0 ? n || (n = r & ~e,
        n !== 0 && (i = pt(n))) : i = pt(o) : i = pt(s)) : (r = s & ~a,
        r === 0 ? (o &= s,
        o === 0 ? n || (n = s & ~e,
        n !== 0 && (i = pt(n))) : i = pt(o)) : i = pt(r)),
    ...
    var kt = Math.random().toString(36).slice(2)
      , At = `__reactFiber$` + kt
      , jt = `__reactProps$` + kt
      , Mt = `__reactContainer$` + kt
      , Nt = `__reactEvents$` + kt
      , Pt = `__reactListeners$` + kt
      , Ft = `__reactHandles$` + kt
      , It = `__reactResources$` + kt
      , Lt = `__reactMarker$` + kt
      , Rt = `__reactLoad$` + kt;
    function zt(e) {
        delete e[At],
    ...
    var Yt = RegExp(`^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$`)
      , Xt = {}
      , Zt = {};
    function Qt(e) {
        return We.call(Zt, e) ? !0 : We.call(Xt, e) ? !1 : Yt.test(e) ? Zt[e] = !0 : (Xt[e] = !0,
        !1)
    }
    var M = !1;
    function $t() {
    ...
    function cn(e) {
        ...
        var n = t.getValue()
          , r = ``;
        return e && (r = an(e) ? e.checked ? `true` : `false` : e.value),
        e = r,
        e !== n && (t.setValue(e),
        !0)
    }
    ...
    function dn(e, t, n, r, i, a, o, s) {
        ...
        t == null ? o !== `submit` && o !== `reset` || e.removeAttribute(`value`) : o === `number` ? (t === 0 && e.value === `` || e.value != t) && (e.value = `` + rn(t)) : e.value !== `` + rn(t) && (e.value = `` + rn(t)),
        t == null ? n == null ? r != null && e.removeAttribute(`value`) : pn(e, rn(n)) : o === `number` && e.value == t ? pn(e, rn(e.value)) : pn(e, rn(t)),
    ...
    function bn(e, t, n) {
        ...
        n != null) {
            ...
            for (var a in t)
                r = t[a],
                t.hasOwnProperty(a) && n[a] !== r && (yn(e, a, r),
                M = !0)
        } else
            for (var o in t)
                t.hasOwnProperty(o) && yn(e, o, t[o])
    }
    function xn(e) {
        if (e.indexOf(`-`) === -1)
            return !1;
    ...
    function An(e) {
        ...
        if (t && (e = t.stateNode)) {
            ...
            t.type) {
            case `input`:
                if (dn(e, n.value, n.defaultValue, n.defaultValue, n.checked, n.defaultChecked, n.type, n.name),
                t = n.name,
                n.type === `radio` && t != null) {
                    for (n = e; n.parentNode; )
                        n = n.parentNode;
                    for (n = n.querySelectorAll(`input[name="` + un(`` + t) + `"][type="radio"]`),
                    t = 0; t < n.length; t++) {
                        var r = n[t];
    ...
    function Wn(e) {
        function t(t, n, r, i, a) {
            ...
            e)
                ...
                this[o] = t ? t(i) : i[o]);
            return this.isDefaultPrevented = (i.defaultPrevented == null ? !1 === i.returnValue : i.defaultPrevented) ? Hn : Un,
    ...
    var Gn = {
        ...
        movementX: function(e) {
            return `movementX` in e ? e.movementX : (e !== Zn && (Zn && e.type === `mousemove` ? (Yn = e.screenX - Zn.screenX,
            Xn = e.screenY - Zn.screenY) : Xn = Yn = 0,
            Zn = e),
            Yn)
        },
    ...
    var P = Wn(C({}, qn, {
        key: function(e) {
            ...
            return e.type === `keypress` ? (e = Vn(e),
            e === 13 ? `Enter` : String.fromCharCode(e)) : e.type === `keydown` || e.type === `keyup` ? ar[e.keyCode] || `Unidentified` : ``
        },
        code: 0,
        location: 0,
        ctrlKey: 0,
      ...
      , hr = [9, 13, 27, 32]
      , gr = Pn && `CompositionEvent` in window
      , _r = null;
    Pn && `documentMode` in document && (_r = document.documentMode);
    var vr = Pn && `TextEvent` in window && !_r
      , yr = Pn && (!gr || _r && 8 < _r && 11 >= _r)
      , br = ` `
      , xr = !1;
    function Sr(e, t) {
        switch (e) {
    ...
    function Er(e, t) {
        if (wr)
            return e === `compositionend` || !gr && Sr(e, t) ? (e = Bn(),
            zn = Rn = Ln = null,
            wr = !1,
            e) : null;
        switch (e) {
    ...
    function kr(e, t, n, r) {
        ...
        t = Jf(t, `onChange`),
        0 < t.length && (n = new Kn(`onChange`,`change`,null,n,r),
        e.push({
            event: n,
            listeners: t
        }))
    ...
    function zr() {
        Ar && (Ar.detachEvent(`onpropertychange`, Br),
        jr = Ar = null)
    }
    function Br(e) {
    ...
    function Vr(e, t, n) {
        ...
        Ar = t,
        jr = n,
        Ar.attachEvent(`onpropertychange`, Br)) : e === `focusout` && zr()
    }
    function Hr(e) {
    ...
    var ei = Pn && `documentMode` in document && 11 >= document.documentMode
      , ti = null
      , ni = null
      , ri = null
      , ii = !1;
    function ai(e, t, n) {
        ...
        ri && qr(ri, r) || (ri = r,
        r = Jf(ni, `onSelect`),
        0 < r.length && (t = new Kn(`onSelect`,`select`,null,t,n),
        e.push({
            event: t,
            listeners: r
        }),
    ...
    var si = {
      ...
      , ci = {}
      , li = {};
    Pn && (li = document.createElement(`div`).style,
    ...
    function ui(e) {
        ...
        var t = si[e], n;
        for (n in t)
            if (t.hasOwnProperty(n) && n in li)
                return ci[e] = t[n];
        return e
    }
    var di = ui(`animationend`)
      , fi = ui(`animationiteration`)
      , pi = ui(`animationstart`)
      , mi = ui(`transitionrun`)
      , hi = ui(`transitionstart`)
      , gi = ui(`transitioncancel`)
      , _i = ui(`transitionend`)
      , vi = new Map
    ...
    function Si(e, t) {
        ...
        var n = xi++;
        return e = `_` + e + `t_` + n.toString(32) + `_`,
        t.autoName = e
    }
    function Ci(e) {
    ...
    function Vi(e, t, n, r, a, o) {
        ...
        typeof r == `function`)
            ...
            s = qm(e, n, ke.current) ? 26 : e === `html` || e === `head` || e === `body` ? 27 : 5;
        else
            a: switch (r) {
            case he:
    ...
    var ca = null
      ...
      , da = Error(i(519));
    function fa(e) {
        throw va(qi(Error(i(418, 1 < arguments.length && arguments[1] !== void 0 && arguments[1] ? `text` : `HTML`, ``)), e)),
        da
    }
    function pa(e) {
        var t = e.stateNode
        ...
        case `input`:
            Q(`invalid`, t),
            fn(t, r.value, r.defaultValue, r.checked, r.defaultChecked, r.type, r.name, !0);
            break;
        case `select`:
            Q(`invalid`, t);
            break;
        case `textarea`:
            Q(`invalid`, t),
            gn(t, r.value, r.defaultValue, r.children)
        }
        n = r.children,
        typeof n != `string` && typeof n != `number` && typeof n != `bigint` || t.textContent === `` + n || !0 === r.suppressHydrationWarning || ep(t.textContent, n) ? (r.popover != null && (Q(`beforetoggle`, t),
        Q(`toggle`, t)),
    ...
    function ha(e) {
        ...
        n = n === `form` || n === `button` || pp(e.type, e.memoizedProps)),
        n = !n),
        n && F && fa(e),
        ma(e),
        t === 13) {
            ...
            Sp(e.type) ? (e = um,
            um = null,
            F = e) : F = t) : F = ca ? lm(e.stateNode.nextSibling) : null;
        return !0
    }
    function ga() {
        F = ca = null,
    ...
    function _a() {
        var e = la;
        return e !== null && (pd === null ? pd = e : pd.push.apply(pd, e),
        la = null),
        e
    }
    function va(e) {
    ...
    var ya = Oe(null)
      ...
      , xa = null;
    function Sa(e, t, n) {
        k(ya, t._currentValue),
        t._currentValue = n
    }
    function Ca(e) {
        e._currentValue = ya.current,
        O(ya)
    }
    function wa(e, t, n) {
        for (; e !== null; ) {
    ...
    function Ta(e, t, n, r) {
        ...
        for (a !== null && (a.return = e); a !== null; ) {
            ...
            if (o !== null) {
                ...
                a.tag === 13 && a.memoizedState !== null && a.memoizedState.dehydrated === null ? (a.lanes |= n,
                s = a.alternate,
                s !== null && (s.lanes |= n),
                wa(a.return, n, e),
                s = a.child,
                s = s === null ? null : s.sibling) : s = a.child;
            if (s !== null)
                s.return = a;
            else
                for (s = a; s !== null; ) {
    ...
    function Ra(e, t) {
        if (e.pendingLanes & 4194048) {
            ...
            for (n === null && (n = e.transitionTypes = []),
            e = 0; e < t.length; e++) {
                var r = t[e];
    ...
    function io(e, t, n) {
        switch (n = e[n],
        n === void 0 ? e.push(t) : n !== t && (t.then(Tn, Tn),
        t = n),
        t.status) {
        case `fulfilled`:
            return t.value;
    ...
    function ao(e) {
        try {
            ...
            throw typeof e == `object` && e && typeof e.then == `function` ? (oo = e,
            $a) : e
        }
    }
    var oo = null;
    ...
    function mo(e, t) {
        throw t.$$typeof === w ? Error(i(525)) : (e = Object.prototype.toString.call(t),
    ...
    function ho(e) {
        ...
        function s(t) {
            return e && t.alternate === null && (t.flags |= 134217730),
            t
        }
        function c(e, t, n, r) {
            return t === null || t.tag !== 6 ? (t = Ui(n, e.mode, r),
            t.return = e,
            t) : (t = a(t, n),
            t.return = e,
            t)
        ...
        function l(e, t, n, r) {
            var i = n.type;
            return i === ae ? (e = d(e, t, n.props.children, r, n.key),
            po(e, n),
            e) : t !== null && (t.elementType === i || typeof i == `object` && i && i.$$typeof === me && ao(i) === t.type) ? (t = a(t, n.props),
            po(t, n),
            t.return = e,
        ...
        function _(e, r, o, c) {
            if (typeof o == `object` && o && o.type === ae && o.key === null && o.props.ref === void 0 && (o = o.props.children),
            typeof o == `object` && o) {
                switch (o.$$typeof) {
                case T:
                    a: {
                        ...
                        o.type === ae ? (c = Hi(o.props.children, e.mode, c, o.key),
                        po(c, o),
                        c.return = e,
    ...
    function Lo(e) {
        ...
        k(Ho, Ho.current & 1),
        k(Fo, e),
        Io === null && (t === null || Ao.current !== null || t.memoizedState !== null) && (Io = e)
    }
    function Ro(e) {
        k(Ho, Ho.current),
        k(Fo, e),
    ...
    function ns(e, t, n, r, i, a) {
        ...
        t.updateQueue = null,
        t.lanes = 0,
        E.H = e === null || e.memoizedState === null ? vc : yc,
        Xo = !1,
        a = n(r, i),
        Xo = !1,
        Yo && (a = is(t, n, r, i)),
    ...
    function as() {
        var e = E.H
          , t = e.useState()[0];
        return t = typeof t.then == `function` ? ds(t) : t,
        e = e.useState()[0],
    ...
    function ls() {
        ...
        return qo === null ? L.memoizedState = qo = e : qo = qo.next = e,
        qo
    }
    function B() {
        if (R === null) {
    ...
    function ds(e) {
        ...
        e = io($o, e, t),
        t = L,
        (qo === null ? t.memoizedState : qo.next) === null && (t = t.alternate,
        E.H = t === null || t.memoizedState === null ? vc : yc),
        e
    }
    function fs(e) {
        if (typeof e == `object` && e) {
    ...
    function vs(e, t, n) {
        ...
        Ic = !0),
        a = a.queue,
        Us(xs.bind(null, r, a, e), [e]),
        e = a.getSnapshot !== t || s || qo !== null && !!(qo.memoizedState.tag & 1),
        Rs(e ? 9 : 8, {
            destroy: void 0
        }, bs.bind(null, r, a, n, t), null),
        e) {
            if (r.flags |= 2048,
            G === null)
                throw Error(i(349));
    ...
    function Vs(e, t, n, r) {
        ...
        R !== null && r !== null && ts(r, R.memoizedState.deps) ? i.memoizedState = Rs(t, a, n, r) : (L.flags |= e,
    ...
    function Zs(e, t) {
        ...
        return t !== null && ts(t, r[1]) ? r[0] : (n.memoizedState = [e, t],
        e)
    }
    function Qs(e, t) {
        var n = B();
    ...
    function $s(e, t, n) {
        return n === void 0 || Ko & 1073741824 && !(q & 261930) ? e.memoizedState = t : (e.memoizedState = n,
        e = Md(),
        L.lanes |= e,
        sd |= e,
        n)
    ...
    function ec(e, t, n, r) {
        return Kr(n, t) ? n : Ao.current === null ? !(Ko & 106) || Ko & 1073741824 && !(q & 261930) ? (Ic = !0,
        e.memoizedState = n) : (e = Md(),
        L.lanes |= e,
        sd |= e,
        t) : (e = $s(e, n, r),
        Kr(e, t) || (Ic = !0),
    ...
    function tc(e, t, n, r, i) {
        ...
        try {
            var c = i()
              , l = E.S;
            l !== null && l(s, c),
            typeof c == `object` && c && typeof c.then == `function` ? fc(e, t, qa(c, r), jd(e)) : fc(e, t, r, jd(e))
        } catch (n) {
            fc(e, t, {
                then: function() {},
                status: `rejected`,
    ...
    var _c = {
      ...
      , vc = {
        ...
        useCallback: function(e, t) {
            return ls().memoizedState = [e, t === void 0 ? null : t],
            e
        },
        useContext: ka,
        useEffect: Hs,
        ...
        useTransition: function() {
            var e = ws(!1);
            return e = tc.bind(null, L, e.queue, !0, !1),
            ls().memoizedState = e,
            [!1, e]
        },
        useSyncExternalStore: function(e, t, n) {
            ...
            return a.queue = o,
            Hs(xs.bind(null, r, o, e), [e]),
            r.flags |= 2048,
            Rs(9, {
                destroy: void 0
            }, bs.bind(null, r, o, n, t), null),
            n
        },
        useId: function() {
            var e = ls()
    ...
    function Cc(e, t, n, r, i, a, o) {
        ...
        typeof e.shouldComponentUpdate == `function` ? e.shouldComponentUpdate(r, a, o) : t.prototype && t.prototype.isPureReactComponent ? !qr(n, r) || !qr(i, a) : !0
    }
    function wc(e, t, n, r) {
        e = t.state,
    ...
    function Pc(e, t, n, r, a) {
        ...
        typeof r == `object` && r && typeof r.then == `function`) {
            ...
            n !== null) {
                ...
                case 13:
                case 19:
                    return Io === null ? Kd() : n.alternate === null && Y === 0 && (Y = 3),
                    n.flags &= -257,
                    n.flags |= 65536,
                    n.lanes = a,
                    r === no ? n.flags |= 16384 : (t = n.updateQueue,
        ...
        do {
            ...
            case 1:
                if (t = n.type,
                o = n.stateNode,
                !(n.flags & 128) && (typeof t.getDerivedStateFromError == `function` || o !== null && typeof o.componentDidCatch == `function` && (yd === null || !yd.has(o))))
                    return n.flags |= 65536,
                    a &= -a,
                    n.lanes |= a,
                    a = Mc(a),
    ...
    function zc(e, t, n, r, i) {
        if (e === null) {
            var a = n.type;
            return typeof a == `function` && !Ri(a) && a.defaultProps === void 0 && n.compare === null ? (t.tag = 15,
            t.type = a,
            Bc(e, t, a, r, i)) : (e = Vi(n.type, null, r, t, t.mode, i),
            e.ref = t.ref,
            e.return = t,
            t.child = e)
        }
    ...
    function Vc(e, t, n, r) {
        ...
        r.mode === `hidden`) {
            ...
            if (n & 536870912)
                ...
                e !== null && Za(t, a === null ? null : a.cachePool),
                a === null ? No() : Mo(t, a),
                zo(t);
            else
    ...
    function Xc(e, t, n, r, i) {
        ...
        t.stateNode === null) {
            ...
            yo(t),
            o = n.contextType,
            a.context = typeof o == `object` && o ? ka(o) : Fi,
            a.state = t.memoizedState,
            o = n.getDerivedStateFromProps,
            typeof o == `function` && (xc(t, n, o, r),
            a.state = t.memoizedState),
            ...
            var l = a.context
              , u = n.contextType;
            o = Fi,
            typeof u == `object` && u && (o = ka(u));
            var d = n.getDerivedStateFromProps;
            u = typeof d == `function` || typeof a.getSnapshotBeforeUpdate == `function`,
            s = t.pendingProps !== s,
            u || typeof a.UNSAFE_componentWillReceiveProps != `function` && typeof a.componentWillReceiveProps != `function` || (s || l !== o) && wc(t, a, r, o),
            vo = !1;
            ...
            Eo(),
            l = t.memoizedState,
            s || f !== l || vo ? (typeof d == `function` && (xc(t, n, d, r),
            l = t.memoizedState),
            (c = vo || Cc(t, n, c, r, f, l, o)) ? (u || typeof a.UNSAFE_componentWillMount != `function` && typeof a.componentWillMount != `function` || (typeof a.componentWillMount == `function` && a.componentWillMount(),
            typeof a.UNSAFE_componentWillMount == `function` && a.UNSAFE_componentWillMount()),
            ...
            l = n.contextType,
            c = Fi,
            typeof l == `object` && l && (c = ka(l)),
            s = n.getDerivedStateFromProps,
            (l = typeof s == `function` || typeof a.getSnapshotBeforeUpdate == `function`) || typeof a.UNSAFE_componentWillReceiveProps != `function` && typeof a.componentWillReceiveProps != `function` || (o !== d || f !== c) && wc(t, a, r, c),
            vo = !1,
            f = t.memoizedState,
            a.state = f,
            Do(t, r, a, i),
            ...
            o !== d || f !== p || vo || e !== null && e.dependencies !== null && Da(e.dependencies) ? (typeof s == `function` && (xc(t, n, s, r),
            p = t.memoizedState),
            (u = vo || Cc(t, n, u, r, f, p, c) || e !== null && e.dependencies !== null && Da(e.dependencies)) ? (l || typeof a.UNSAFE_componentWillUpdate != `function` && typeof a.componentWillUpdate != `function` || (typeof a.componentWillUpdate == `function` && a.componentWillUpdate(r, p, c),
        ...
        t.flags |= 1,
        e !== null && r ? (t.child = go(t, e.child, null, i),
        t.child = go(t, null, n, i)) : Lc(e, t, n, i),
        t.memoizedState = a.state,
        e = t.child) : e = fl(e, t, i),
        e
    }
    function Zc(e, t, n, r) {
        return ga(),
    ...
    function tl(e, t, n) {
        ...
        if ((o = a) || (o = e !== null && e.memoizedState === null ? !1 : !!(Ho.current & 2)),
        o && (i = !0,
        t.flags &= -129),
        o = !!(t.flags & 32),
        t.flags &= -33,
        e === null) {
            if (I) {
                ...
                e === null)
                    throw fa(t);
                return t.lanes = sm(e) ? 32 : 536870912,
                null
            }
            return a = r.children,
            r = r.fallback,
        ...
        i === null ? i = $c(n) : (a = i.cachePool,
        a === null ? a = Qa() : (s = Fa._currentValue,
        a = a.parent === s ? a : {
            parent: s,
            pool: s
        }),
    ...
    function al(e, t, n, r, a, o, s, c) {
        if (n)
            return t.flags & 256 ? (Lo(t),
            t.flags &= -257,
            il(e, t, c)) : t.memoizedState === null ? (Bo(),
            o = a.fallback,
            s = t.mode,
            a = rl({
                mode: `visible`,
    ...
    function hl(e, t, n) {
        if (e !== null) {
            ...
            Ic = !1,
            I && t.flags & 1048576 && ia(t, Zi, t.index);
        switch (t.lanes = 0,
        t.tag) {
        case 16:
            a: {
                var r = t.pendingProps;
                if (e = ao(t.elementType),
                t.type = e,
                typeof e == `function`)
                    Ri(e) ? (r = Tc(e, r),
                    t.tag = 1,
        ...
        case 26:
            return qc(e, t),
            e === null ? (n = Nm(t.type, null, t.pendingProps, null)) ? t.memoizedState = n : I || (t.stateNode = fp(t.type, t.pendingProps, je.current, t)) : t.memoizedState = Nm(t.type, e.memoizedProps, t.pendingProps, e.memoizedState),
            null;
        case 27:
            return Fe(t),
            e === null && I && (r = t.stateNode = hm(t.type, t.pendingProps, je.current),
            ca = t,
            ua = !0,
            a = F,
            Sp(t.type) ? (um = a,
            F = lm(r.firstChild)) : F = a),
            Lc(e, t, t.pendingProps.children, n),
            qc(e, t),
            e === null && (t.flags |= 4194304),
            t.child;
        case 5:
            return e === null && I && ((a = r = F) && (r = rm(r, t.type, t.pendingProps, ua),
            ...
            t.memoizedState !== null && (a = ns(e, t, as, null, null, n),
            sh._currentValue = a),
            qc(e, t),
            Lc(e, t, r, n),
            t.child;
        case 6:
            return e === null && I && ((e = n = F) && (n = im(n, t.pendingProps, ua),
        ...
        case 4:
            ...
            r = t.pendingProps,
            e === null ? t.child = go(t, null, r, n) : Lc(e, t, r, n),
            t.child;
        case 11:
        ...
        case 7:
            ...
            t.child;
        case 8:
            return Lc(e, t, t.pendingProps.children, n),
            t.child;
        case 12:
            return Lc(e, t, t.pendingProps.children, n),
            t.child;
        ...
        case 30:
            ...
            r = t.pendingProps,
            r.name != null && r.name !== `auto` ? t.flags |= e === null ? 18882560 : 18874368 : I && aa(t),
    ...
    function _l(e, t, n, r, i) {
        var a;
        if ((a = !!(e.mode & 32)) && (a = n === null ? Jm(t, r) : Jm(t, r) && (r.src !== n.src || r.srcSet !== n.srcSet)),
        a) {
            if (e.flags |= 16777216,
            (i & 335544128) === i) {
    ...
    function yl(e, t) {
        t !== null && (e.flags |= 4),
        e.flags & 16384 && (t = e.tag === 22 ? 536870912 : vt(),
        e.lanes |= t,
        dd |= t)
    }
    function bl(e, t) {
    ...
    function xl(e, t, n) {
        ...
        case 3:
            ...
            (e === null || e.child === null) && (ha(t) ? gl(t) : e === null || e.memoizedState.isDehydrated && !(t.flags & 256) || (t.flags |= 1024,
            _a())),
            V(t),
            null;
        case 26:
            ...
            o === null ? (V(t),
            _l(t, a, null, r, n)) : (V(t),
            vl(t, o))) : o ? o === e.memoizedState ? (V(t),
            t.flags &= -16777217) : (gl(t),
            V(t),
            vl(t, o)) : (e = e.memoizedProps,
            e !== r && gl(t),
            V(t),
            _l(t, a, e, r, n)),
            null;
        ...
        case 6:
            if (e && t.stateNode != null)
                ...
                ha(t)) {
                    ...
                    e[At] = t,
                    e = !!(e.nodeValue === n || r !== null && !0 === r.suppressHydrationWarning || ep(e.nodeValue, n)),
                    e || fa(t, !0)
                } else
        ...
        case 19:
            ...
            o === null) {
                        ...
                        for (e = t.child; e !== null; ) {
                            ...
                            o !== null) {
                                ...
                                n = t.child; n !== null; )
                                    Bi(n, e),
                                    n = n.sibling;
                                return Uo(t, Ho.current & 1 | 2),
                                I && ra(t, r.treeForkCount),
                                t.child
                            }
                            e = e.sibling
                        }
                    r.tail !== null && Ye() > _d && (t.flags |= 128,
                    a = !0,
                    bl(r, !1),
                    t.lanes = 4194304)
                }
                ...
                if (!a) {
                    ...
                    e !== null) {
                        ...
                        yl(t, e),
                        bl(r, !0),
                        r.tail === null && r.tailMode !== `collapsed` && r.tailMode !== `visible` && !o.alternate && !I)
                            return V(t),
                            null
                    } else
                        2 * Ye() - r.renderingStartTime > _d && n !== 536870912 && (t.flags |= 128,
                        a = !0,
                        bl(r, !1),
                        t.lanes = 4194304)
                }
            ...
            if (r.tail !== null) {
                ...
                o = Ho.current,
                o = a ? o & 1 | 2 : o & 1,
                r.tailMode === `visible` || r.tailMode === `collapsed` || !n || I ? Uo(t, o) : (n = o,
                k(Fo, t),
                k(Ho, n),
                Io === null && (Io = t)),
                I && ra(t, r.treeForkCount),
    ...
    function Dl(e, t, n) {
        n.props = Tc(e.type, e.memoizedProps),
        ...
        try {
            ...
            if (n !== null) {
                ...
                case 7:
                    if (e.stateNode === null) {
                        var o = new Fp(e);
                        h(e.child, !1, Qp, o, void 0, void 0),
                        e.stateNode = o
                    }
                    r = e.stateNode;
                    break;
    ...
    function jl(e) {
        for (var t = e.return; t !== null && (Pl(t) && em(e.stateNode, t.stateNode),
        !Nl(t)); )
            t = t.return
    }
    function Ml(e) {
        for (var t = e.return; t !== null && (Pl(t) && tm(e.stateNode, t.stateNode),
        !Nl(t)); )
            t = t.return
    }
    function Nl(e) {
    ...
    function zl(e, t, n, r) {
        ...
        if (i === 5 || i === 6)
            i = e.stateNode,
            t ? (n.nodeType === 9 ? n.body : n.nodeName === `HTML` ? n.ownerDocument.body : n).insertBefore(i, t) : (t = n.nodeType === 9 ? n.body : n.nodeName === `HTML` ? n.ownerDocument.body : n,
            t.appendChild(i),
            n = n._reactRootContainer,
            n != null || t.onclick !== null || (t.onclick = Tn)),
            Al(e, r),
            M = !0;
        else if (i !== 4 && (i === 27 && (Al(e, r),
        r = null,
        Sp(e.type) && (n = e.stateNode,
        t = null)),
        e = e.child,
        e !== null))
            for (zl(e, t, n, r),
        ...
        for (var a = !1; e !== null; ) {
            if (e.tag === 5) {
                ...
                if (r !== null) {
                    ...
                    a || Op(o).view && (a = !0);
                Hl = !0,
                Tp(o, ql === 0 ? t : t + `_` + ql, n),
                ql++
            } else
                (e.tag !== 22 || e.memoizedState === null) && (e.tag === 30 && i || Yl(e.child, t, n, r, i) && (a = !0));
            e = e.sibling
        }
        return a
    }
    function Xl(e, t) {
        for (; e !== null; )
            e.tag === 5 ? Ep(e.stateNode, e.memoizedProps) : (e.tag !== 22 || e.memoizedState === null) && (e.tag === 30 && t || Xl(e.child, t)),
            e = e.sibling
    }
    function Zl(e) {
        if (e.subtreeFlags & 18874368)
            for (e = e.child; e !== null; ) {
                if ((e.tag !== 22 || e.memoizedState === null) && (Zl(e),
                e.tag === 30 && e.flags & 18874368 && e.stateNode.paired)) {
                    var t = e.memoizedProps;
                    if (t.name == null || t.name === `auto`)
                        throw Error(i(544));
                    var n = t.name;
                    t = wi(t.default, t.share),
    ...
    function Ql(e, t) {
        if (e.tag === 30) {
            var n = e.stateNode
              , r = e.memoizedProps
              , i = Si(r, n)
              , a = wi(r.default, n.paired ? r.share : r.enter);
            a === `none` ? Zl(e) : Jl(e, i, a, null, !1) ? (Zl(e),
            n.paired || t || Nd(e, r.onEnter)) : Xl(e.child, !1)
                        ...
                        if (e.tag === 30 && e.flags & 18874368) {
                            ...
                            if (r != null && r !== `auto`) {
                                ...
                                if (i !== void 0) {
                                    ...
                                    if (a !== `none` && (Jl(e, r, a, null, !1) ? (a = e.stateNode,
                                    i.paired = a,
                                    a.paired = i,
                                    Nd(e, n.onShare)) : Xl(e.child, !1)),
                                    t.delete(r),
                                    t.size === 0)
                                        break
                                }
    ...
    function eu(e) {
        if (e.tag === 30) {
            var t = e.memoizedProps
              ...
              , i = wi(t.default, r === void 0 ? t.exit : t.share);
            i !== `none` && (Jl(e, n, i, null, !1) ? r === void 0 ? Nd(e, t.onExit) : (i = e.stateNode,
            r.paired = i,
            i.paired = r,
            Ul.delete(n),
            Nd(e, t.onShare)) : Xl(e.child, !1)),
            Ul !== null && $l(e)
        } else if (e.subtreeFlags & 33554432)
            for (e = e.child; e !== null; )
                eu(e),
    ...
    function tu(e) {
        for (e = e.child; e !== null; ) {
            if (e.tag === 30) {
                var t = e.memoizedProps
                  , n = Si(t, e.stateNode);
                t = wi(t.default, t.update),
                e.flags &= -5,
                t !== `none` && Jl(e, n, t, e.memoizedState = [], !1)
            } else
                e.subtreeFlags & 33554432 && tu(e);
            e = e.sibling
        }
    }
    function nu(e) {
    ...
    function au(e, t, n, r, i, a, o) {
        for (var s = !1; t !== null; ) {
            if (t.tag === 5) {
                ...
                s && e.flags & 4 || (Gl === null && (Gl = []),
                Gl.push(c, ql === 0 ? r : r + `_` + ql, t.memoizedProps)),
                ql++
            } else
                (t.tag !== 22 || t.memoizedState === null) && (t.tag === 30 && o ? e.flags |= t.flags & 32 : au(e, t.child, n, r, i, a, o) && (s = !0));
            t = t.sibling
        }
        return s
    }
    function ou(e, t) {
        for (e = e.child; e !== null; ) {
            if (e.tag === 30) {
                ...
                e.subtreeFlags & 33554432 && ou(e, t);
            e = e.sibling
        }
    }
    var su = !1
    ...
    function gu(e, t, n) {
                ...
                a: {
                    ...
                    if (i && i.rangeCount !== 0) {
                        ...
                        var s = 0
                          ...
                          , p = null;
                        b: for (; ; ) {
                            for (var m; f !== r || a !== 0 && f.nodeType !== 3 || (c = s + a),
        ...
        n = (n & 335544064) === n,
        du = t,
        t = n ? 9270 : 1024; du !== null; ) {
            if (e = du,
            n && (r = e.deletions,
            r !== null))
                for (a = 0; a < r.length; a++)
                    n && eu(r[a]);
            if (e.alternate === null && e.flags & 2)
                n && Wl(e),
                _u(n);
            else {
                if (e.tag === 22) {
                    if (r = e.alternate,
                    e.memoizedState !== null) {
                        r !== null && r.memoizedState === null && n && eu(r),
                        _u(n);
                        continue
                    }
                ...
                r = e.child,
                (e.subtreeFlags & t) !== 0 && r !== null ? (r.return = e,
                du = r) : (n && tu(e),
                _u(n))
            }
        }
    ...
    function _u(e) {
        for (; du !== null; ) {
            ...
            case 3:
                if (a & 1024) {
                    if (r = t.stateNode.containerInfo,
                    n = r.nodeType,
                    n === 9)
                        nm(r);
                    else if (n === 1)
            ...
            case 17:
                break;
            case 30:
                n && r !== null && (n = Si(r.memoizedProps, r.stateNode),
                a = t.memoizedProps,
                a = wi(a.default, a.update),
    ...
    function vu(e, t, n) {
        ...
        case 13:
            ...
            e !== null && (n = _f.bind(null, n),
            cm(e, n))));
            break;
        case 22:
            if (r = n.memoizedState !== null || su,
            !r) {
    ...
    function Tu(e, t, n) {
        ...
        case 26:
            H || kl(n, t),
            wu(e, t, n),
            n.memoizedState ? n.memoizedState.count-- : n.stateNode && !H && (n = n.stateNode,
        ...
        case 18:
            U !== null && (Cu ? (e = U,
            Cp(e.nodeType === 9 ? e.body : e.nodeName === `HTML` ? e.ownerDocument.body : e, n.stateNode),
            Hh(e)) : Cp(U, n.stateNode));
            break;
        case 4:
            r = U,
            i = Cu,
    ...
    function Ou(e) {
        ...
        case 19:
            var t = e.stateNode;
            return t === null && (t = e.stateNode = new uu),
            t;
        case 22:
            return e = e.stateNode,
            t = e._retryCache,
    ...
    function Mu(e, t, n) {
        ...
        case 1:
            ...
            a & 64 && su && (e = e.updateQueue,
            e !== null && (t = e.callbacks,
            t !== null && (n = e.shared.hiddenCallbacks,
        ...
        case 26:
            ...
            a & 512 && (H || r === null || kl(r, r.return)),
            a & 4) {
                if (a = r === null ? null : r.memoizedState,
                n = e.memoizedState,
                r === null) {
                    if (n === null) {
                        if (e.stateNode === null) {
                            if (su)
                                e.stateNode = fp(e.type, e.memoizedProps, t.containerInfo, e);
                            else {
                                a: {
                                    t = e.type,
                                    n = e.memoizedProps,
                                    ...
                                    case `title`:
                                        ...
                                        (!r || r[Lt] || r[At] || r.namespaceURI === `http://www.w3.org/2000/svg` || r.hasAttribute(`itemprop`)) && (r = a.createElement(t),
                        ...
                        e.stateNode = Bm(o, n, e.memoizedProps)
                } else
                    a === n ? n === null && e.stateNode !== null && Il(e, e.memoizedProps, r.memoizedProps) : (a === null ? (t = r.stateNode,
                    t === null || H || t.parentNode.removeChild(t)) : a.count--,
        ...
        case 5:
            ...
            Il(e, t, r === null ? t : r.memoizedProps)),
            a & 1024 && (lu = !0);
            break;
        case 6:
            if (Au(t, e, n),
        ...
        case 13:
            Au(t, e, n),
            Nu(e),
            e.child.flags & 8192 && e.memoizedState !== null != (r !== null && r.memoizedState !== null) && (hd = Ye()),
            a & 4 && (t = e.updateQueue,
            t !== null && (e.updateQueue = null,
            ku(e, t)));
            break;
        case 22:
            ...
            !o && cu || yu(e, o)),
            a & 4 && (t = e.updateQueue,
            t !== null && (n = t.retryQueue,
            n !== null && (t.retryQueue = null,
            ku(e, n))));
            break;
        case 19:
            Au(t, e, n),
        ...
        case 30:
            ...
            s = (n & 335544064) === n,
            c = e.memoizedProps,
            pu = s && wi(c.default, c.update) !== `none`,
            Au(t, e, n),
            Nu(e),
        ...
        if (n === null)
            ...
            case 30:
                ...
                var a = e.memoizedProps
                  , o = e.stateNode;
                t = Si(a, o),
                o = Si(n.memoizedProps, o);
                var s = wi(a.default, a.update);
                s === `none` ? t = !1 : (a = n.memoizedState,
                n.memoizedState = null,
                n = e.child,
                ql = 0,
                t = au(e, n, t, o, s, a, !0),
                ql !== (a === null ? 0 : a.length) && (e.flags |= 32)),
                e.flags & 4 && t ? (Nd(e, e.memoizedProps.onUpdate),
                Gl = i) : i !== null && (i.push.apply(i, Gl),
                Gl = i),
                fu = e.flags & 32 ? !0 : r;
                break;
            default:
    ...
    function zu(e, t, n) {
        for (n = t.subtreeFlags & 8772 ? n : n & -2,
        t = t.child; t !== null; ) {
            var r = t.alternate
              , i = e
              , a = t
    ...
    function Uu(e, t, n, r) {
        ...
        case 22:
            o = t.stateNode,
            s = t.alternate,
            t.memoizedState === null ? (i && s !== null && s.memoizedState !== null && ru(t),
            o._visibility & 2 ? Hu(e, t, n, r) : (o._visibility |= 2,
            Wu(e, t, n, r, !!(t.subtreeFlags & 10256) || !1))) : (i && s !== null && s.memoizedState === null && ru(s),
            o._visibility & 2 ? Hu(e, t, n, r) : Gu(e, t)),
            a & 2048 && Bu(s, t);
            break;
        case 24:
            Hu(e, t, n, r),
            a & 2048 && Vu(t.alternate, t);
            break;
        case 30:
            i && (a = t.alternate,
            a !== null && (Xl(a.child, !0),
    ...
    function Wu(e, t, n, r, i) {
        ...
        t = t.child; t !== null; ) {
            ...
            case 22:
                ...
                Wu(a, o, s, c, i)) : u._visibility & 2 ? Wu(a, o, s, c, i) : Gu(a, o),
                i && l & 2048 && Bu(o.alternate, o);
                break;
            case 24:
                Wu(a, o, s, c, i),
                i && l & 2048 && Vu(o.alternate, o);
                break;
            default:
                Wu(a, o, s, c, i)
            }
    ...
    function Gu(e, t) {
        if (t.subtreeFlags & 10256)
            for (t = t.child; t !== null; ) {
                ...
                case 22:
                    Gu(n, r),
                    i & 2048 && Bu(r.alternate, r);
                    break;
                case 24:
                    Gu(n, r),
                    i & 2048 && Vu(r.alternate, r);
                    break;
                default:
                    Gu(n, r)
                }
    ...
    function Ju(e, t, n) {
        ...
        case 26:
            qu(e, t, n),
            e.flags & Ku && (e.memoizedState === null ? (e = e.stateNode,
            (t & 335544128) === t && Zm(n, e)) : Qm(n, ju, e.memoizedState, e.memoizedProps));
            break;
        case 5:
            qu(e, t, n),
            e.flags & Ku && (e = e.stateNode,
            (t & 335544128) === t && Zm(n, e));
            break;
        case 3:
        case 4:
            var r = ju;
        ...
        case 22:
            ...
            r !== null && r.memoizedState !== null ? (r = Ku,
            Ku = 16777216,
            qu(e, t, n),
            Ku = r) : qu(e, t, n));
            break;
        case 30:
            if ((e.flags & Ku) !== 0 && (r = e.memoizedProps.name,
            r != null && r !== `auto`)) {
                var i = e.stateNode;
                i.paired = null,
                Ul === null && (Ul = new Map),
    ...
    var ed = {
      ...
      , Ad = null;
    function jd() {
        return W & 2 && q !== 0 ? q & -q : E.T === null ? Dt() : Pf()
    }
    function Md() {
        if (ud === 0) {
            if (!(q & 536870912) || I) {
    ...
    function Nd(e, t) {
        if (t != null) {
            var n = e.stateNode
              , r = n.ref;
            r === null && (r = n.ref = Pp(Si(e.memoizedProps, n))),
            Dd === null && (Dd = []),
            Dd.push(t.bind(null, r))
        }
    }
    function Pd(e, t, n) {
        (e === G && (J === 2 || J === 9) || e.cancelPendingCommit !== null) && (Vd(e, 0),
        Rd(e, q, ud, !1)),
        bt(e, n),
        (!(W & 2) || e !== G) && (e === G && (!(W & 2) && (cd |= n),
        Y === 4 && Rd(e, q, ud, !1)),
        Ef(e))
    }
    function Fd(e, t, n) {
        ...
        do {
                ...
                if (s !== 0) {
                    ...
                    a: {
                        ...
                        s !== 2 && s !== 6) {
                            ...
                            o = pd,
                            pd = a,
                            o !== null && (pd === null ? pd = o : pd.push.apply(pd, o))
                        }
                        a = s
                    }
                    if (o = !1,
            ...
            a: {
                ...
                if ((t & 62914560) === t && (a = hd + 300 - Ye(),
                10 < a)) {
                    if (Rd(r, t, ud, !rd),
                    mt(r, 0, !0) !== 0)
                        break a;
                    Sd = t,
                    r.timeoutHandle = gp(Id.bind(null, r, n, pd, vd, md, t, ud, cd, dd, rd, o, `Throttled`, -0, 0), a);
                    break a
                }
    ...
    function Id(e, t, n, r, i, a, o, s, c, l, u, d, f, p) {
        ...
        var m = t.subtreeFlags
          , h = (a & 335544064) === a;
        if (d = null,
        (h || m & 8192 || (m & 16785408) == 16785408) && (d = {
            stylesheets: null,
            count: 0,
            imgCount: 0,
            imgBytes: 0,
        ...
        m = nh.bind(m),
        h.finished.then(m, m))),
        m = (a & 62914560) === a ? hd - Ye() : (a & 4194048) === a ? gd - Ye() : 0,
        m = eh(d, m),
        m !== null)) {
            Sd = a,
            e.cancelPendingCommit = m(nf.bind(null, e, t, a, n, r, i, o, s, c, l, u, d, null, f, p)),
            Rd(e, a, o, !l);
            return
        }
    ...
    function Hd(e, t) {
        ...
        t === $a || t === to ? (t = so(),
        J = 3) : t === eo ? (t = so(),
        J = 4) : J = t === Fc ? 8 : typeof t == `object` && t && typeof t.then == `function` ? 6 : 1,
        nd = t,
        K === null && (Y = 1,
        kc(e, qi(t, e.current)))
    }
    ...
    function Kd() {
        Y = 4,
        rd || (q & 4194048) !== q && Fo.current !== null || (id = !0),
    ...
    function Qd(e) {
        ...
        case 5:
            ...
            var r = t;
            r === ca && (I ? (ma(r),
            r.tag === 5 && r.stateNode != null && (F = r.stateNode)) : (ma(r),
            I = !0));
        default:
            Cl(n, t),
            t = K = Bi(t, od),
    ...
    function $d(e, t, n, r) {
        ...
        t.flags & 32768 ? (I || r === 1 ? e = !0 : id || q & 536870912 ? e = !1 : (rd = e = !0,
        (r === 2 || r === 9 || r === 3 || r === 6) && (r = Fo.current,
    ...
    function rf(e, t, n, r, i, a, o) {
        ...
        xt(e, n, s, r, i, a),
        Dd = null,
        (n & 335544064) === n ? (Od = Ba(e),
        r = 10262) : (Od = null,
        r = 10256),
        (t.subtreeFlags & r) !== 0 || (t.flags & r) !== 0 ? (e.callbackNode = null,
        ...
        X = 1,
        Hl ? Ed = Mp(o, e.containerInfo, Od, sf, cf, of, lf, ff, af, null, null) : (sf(),
        cf(),
        lf())
    }
    function af(e) {
    ...
    function lf() {
        if (X === 4 || X === 3) {
            ...
            if ((n.subtreeFlags & a) !== 0 || (n.flags & a) !== 0 ? X = 5 : (X = 0,
            xd = bd = null,
            uf(t, t.pendingLanes)),
            a = t.pendingLanes,
            a === 0 && (yd = null),
    ...
    function df() {
        return Ed !== null && (Ed.skipTransition(),
        Ed = null),
        sf(),
        cf(),
        lf(),
    ...
    function hf(e, t, n) {
        ...
        e.warmLanes &= ~n,
        G === e && (q & n) === n && (Y === 4 || Y === 3 && (q & 62914560) === q && 300 > Ye() - hd ? W & 2 ? ld |= n : Vd(e, 0) : ld |= n,
        dd === q && (dd = 0)),
        Ef(e)
    }
    function gf(e, t) {
                ...
                for (var n = !1, r = bf; r !== null; ) {
                    if (!t) {
                        if (e !== 0) {
                            ...
                            a = q,
                            a = mt(r, r === G ? a : 0, r.cancelPendingCommit !== null || r.timeoutHandle !== -1),
                            !(a & 3) || ht(r, a) || (n = !0,
                            Mf(r, a))
                    }
                    r = r.next
    ...
    function Af(e, t) {
        for (var n = e.suspendedLanes, r = e.pingedLanes, i = e.expirationTimes, a = e.pendingLanes & -62914561; 0 < a; ) {
            var o = 31 - A(a)
              , s = 1 << o
              , c = i[o];
            c === -1 ? ((s & n) === 0 || (s & r) !== 0) && (i[o] = _t(s, t)) : c <= t && (e.expiredLanes |= s),
            a &= ~s
        }
        if (t = G,
        n = q,
        n = mt(e, e === t ? n : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1),
        r = e.callbackNode,
    ...
    function jf(e, t) {
        ...
        if (df() && e.callbackNode !== n)
            return null;
        var r = q;
        return r = mt(e, e === G ? r : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1),
        r === 0 ? null : (Fd(e, r, t),
        Af(e, Ye()),
    ...
    function If(e, t, n, r, i) {
        if (t === `submit` && n && n.stateNode === i) {
            var a = Ff((i[jt] || null).action)
              , o = r.submitter;
            o && (t = (t = o[jt] || null) ? Ff(t.formAction) : o.getAttribute(`formAction`),
            t !== null && (a = t,
            o = null));
    ...
    bi(di, `onAnimationEnd`),
    bi(fi, `onAnimationIteration`),
    bi(pi, `onAnimationStart`),
    bi(`dblclick`, `onDoubleClick`),
    bi(`focusin`, `onFocus`),
    bi(`focusout`, `onBlur`),
    bi(mi, `onTransitionRun`),
    bi(hi, `onTransitionStart`),
    bi(gi, `onTransitionCancel`),
    bi(_i, `onTransitionEnd`),
    ...
    var zf = `abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting`.split(` `)
      , Bf = new Set(`beforetoggle cancel close invalid load scroll scrollend toggle`.split(` `).concat(zf));
    function Vf(e, t) {
        t = !!(t & 4);
    ...
    function Wf(e) {
        if (!e[Uf]) {
            ...
            Gt.forEach(function(t) {
                t !== `selectionchange` && (Bf.has(t) || Hf(t, !1, e),
                Hf(t, !0, e))
            });
        ...
        Mn(function() {
            ...
            a: {
                ...
                if (c !== void 0) {
                    ...
                    for (var m = r, h; m !== null; ) {
                        ...
                        if (h = g.stateNode,
                        g = g.tag,
                        g !== 5 && g !== 26 && g !== 27 || h === null || p === null || (g = Nn(m, p),
                        g != null && d.push(qf(m, g, h))),
                        f)
                            break;
                        m = m.return
                    }
            ...
            if (!(t & 7)) {
                a: {
                    ...
                    l && n !== En && (u = n.relatedTarget || n.fromElement) && (Bt(u) || u[Mt]))
                        break a;
                    (c || l) && (u = i.window === i ? i : (l = i.ownerDocument) ? l.defaultView || l.parentWindow : window,
                    c ? (l = n.relatedTarget || n.toElement,
                    c = r,
                    l = l ? Bt(l) : null,
                    l !== null && (f = o(l),
                    d = l.tag,
                    l !== f || d !== 5 && d !== 27 && d !== 6) && (l = null)) : (c = null,
                    l = r),
                    c !== l && (d = Qn,
                    g = `onMouseLeave`,
                    p = `onMouseEnter`,
                    m = `mouse`,
                    (e === `pointerout` || e === `pointerover`) && (d = lr,
                    g = `onPointerLeave`,
                    p = `onPointerEnter`,
                    m = `pointer`),
                    f = c == null ? u : Ht(c),
                    ...
                    u.relatedTarget = h,
                    g = null,
                    Bt(i) === r && (d = new d(p,m + `enter`,l,n,i),
                    d.target = h,
                    d.relatedTarget = f,
                    g = d),
                    f = g,
                ...
                a: {
                    ...
                    l === `select` || l === `input` && c.type === `file`)
                        ...
                        l = c.nodeName,
                        !l || l.toLowerCase() !== `input` || c.type !== `checkbox` && c.type !== `radio` ? r && xn(r.elementType) && (_ = Pr) : _ = Ur;
                    if (_ &&= _(e, r)) {
                        kr(s, _, n, i);
                        break a
                    }
                ...
                switch (v = r ? Ht(r) : window,
                e) {
                case `focusin`:
                    (Or(v) || v.contentEditable === `true`) && (ti = v,
                    ni = r,
                    ri = null);
                    break;
                case `focusout`:
                ...
                if (gr)
                    ...
                    wr ? Sr(e, n) && (b = `onCompositionEnd`) : e === `keydown` && n.keyCode === 229 && (b = `onCompositionStart`);
                b && (yr && n.locale !== `ko` && (wr || b !== `onCompositionStart` ? b === `onCompositionEnd` && wr && (y = Bn()) : (Ln = i,
                Rn = `value` in Ln ? Ln.value : Ln.textContent,
                wr = !0)),
                v = Jf(r, b),
                0 < v.length && (b = new rr(b,e,null,n,i),
                s.push({
                    event: b,
                    listeners: v
                }),
                y ? b.data = y : (y = Cr(n),
                y !== null && (b.data = y)))),
                (y = vr ? Tr(e, n) : Er(e, n)) && (b = Jf(r, `onBeforeInput`),
                0 < b.length && (v = new rr(`onBeforeInput`,`beforeinput`,null,n,i),
                s.push({
                    event: v,
                    listeners: b
                }),
    ...
    function Xf(e, t, n, r, i) {
        for (var a = t._reactName, o = []; n !== null && n !== r; ) {
            ...
            i ? (l = Nn(n, a),
            l != null && o.unshift(qf(n, l, c))) : i || (l = Nn(n, a),
            l != null && o.push(qf(n, l, c)))),
            n = n.return
        }
        o.length !== 0 && e.push({
            event: t,
...
`).replace(Qf, ``)
    ...
    function $(e, t, n, r, a, o) {
        ...
        case `formAction`:
            ...
            if (typeof o == `function` && (n === `formAction` ? (t !== `input` && $(e, t, `name`, a.name, a, null),
        ...
        default:
            if (!Kt.hasOwnProperty(n))
                a: {
                    ...
                    typeof r == `function`)) {
                        typeof t != `function` && t !== null && (n in e ? e[n] = null : e.hasAttribute(n) && e.removeAttribute(n)),
                        e.addEventListener(o, r, a);
                        break a
                    }
                    M = !0,
                    n in e ? e[n] = r : !0 === r ? e.setAttribute(n, ``) : en(e, n, r)
                }
            return
        }
        M = !0
    ...
    function ip(e, t, n, r) {
        ...
        case `select`:
            ...
            n = s,
            r = m,
            p == null ? !!r != !!n && (t == null ? mn(e, !!n, n ? [] : ``, !1) : mn(e, !!n, t, !0)) : mn(e, !!n, p, !1);
            return;
        case `textarea`:
            for (c in m = p = null,
            n)
        ...
        default:
            if (xn(t)) {
                for (var _ in n)
                    p = n[_],
                    n.hasOwnProperty(_) && p !== void 0 && !r.hasOwnProperty(_) && tp(e, t, _, void 0, r, p);
                for (d in r)
                    p = r[d],
                    m = n[d],
                    !r.hasOwnProperty(d) || p === m || p === void 0 && m === void 0 || tp(e, t, d, p, r, m);
                return
            }
        }
        for (var v in n)
    ...
    function hp() {
        var e = window.event;
        return e && e.type === `popstate` ? e !== mp && (mp = e,
        !0) : (mp = null,
        !1)
    }
    var gp = typeof setTimeout == `function` ? setTimeout : void 0
      ...
      , bp = typeof queueMicrotask == `function` ? queueMicrotask : vp === void 0 ? gp : function(e) {
        ...
        do {
            ...
            i && i.nodeType === 8) {
                ...
                n === `/$` || n === `/&`) {
                    ...
                    _m(e.ownerDocument.documentElement);
                else if (n === `head`) {
                    ...
                    for (var a = n.firstChild; a; ) {
                        var o = a.nextSibling
                          , s = a.nodeName;
                        a[Lt] || s === `SCRIPT` || s === `STYLE` || s === `LINK` && a.rel.toLowerCase() === `stylesheet` || n.removeChild(a),
                        a = o
                    }
                } else
                    n === `body` && _m(e.ownerDocument.body)
            }
            n = i
        } while (n);
        Hh(t)
    ...
    function Tp(e, t, n) {
        if (t = CSS.escape(t) === t ? t : `r-` + btoa(t).replace(/=/g, ``),
    ...
    function Ep(e, t) {
        ...
        n = t == null ? null : t.hasOwnProperty(`viewTransitionClass`) ? t.viewTransitionClass : t.hasOwnProperty(`view-transition-class`) ? t[`view-transition-class`] : null,
        e.viewTransitionClass = n == null || typeof n == `boolean` ? `` : (`` + n).trim(),
        e.display === `inline-block` && (t == null ? e.display = e.margin = `` : (n = t.display,
        e.display = n == null || typeof n == `boolean` ? `` : n,
        n = t.margin,
        n == null ? (n = t.hasOwnProperty(`marginTop`) ? t.marginTop : t[`margin-top`],
        e.marginTop = n == null || typeof n == `boolean` ? `` : n,
        t = t.hasOwnProperty(`marginBottom`) ? t.marginBottom : t[`margin-bottom`],
        e.marginBottom = t == null || typeof t == `boolean` ? `` : t) : e.margin = n))
    }
    function Dp(e, t, n) {
    ...
    function Mp(e, t, n, r, i, a, o, s, c) {
        ...
        try {
                        ...
                        for (var c = e.suspenseyImages, u = 0, d = 0; d < c.length; d++) {
                            ...
                            if (!f.complete) {
                                ...
                                if (0 < p.bottom && 0 < p.right && p.top < t.innerHeight && p.left < t.innerWidth) {
                                    ...
                                    f = new Promise(jp.bind(f)),
                                    s.push(f)
                                }
                            }
                        }
                    if (0 < s.length)
                        return t = Promise.race([Promise.all(s), new Promise(function(e) {
            ...
            return u.ready.then(function() {
                for (var e = l.documentElement.getAnimations({
                    subtree: !0
                }), t = 0; t < e.length; t++) {
                    var n = e[t]
                      , r = n.effect
                    ...
                    if (i != null && i.startsWith(`::view-transition`)) {
                        ...
                        s && i !== void 0 && a !== void 0 && (r.setKeyframes(n),
                        s = getComputedStyle(r.target, r.pseudoElement),
                        s.width !== i || s.height !== a) && (s = n[0],
                        s.width = i,
                        s.height = a,
                        s = n[n.length - 1],
                        s.width = i,
                ...
                try {
                    if (typeof e == `object` && e)
                        ...
                        case `InvalidStateError`:
                            (e.message === `View transition was skipped because document visibility state is hidden.` || e.message === `Skipping view transition because document visibility state has become hidden.` || e.message === `Skipping view transition because viewport size changed.` || e.message === `Transition was aborted because of invalid state`) && (e = null)
                        }
                    e !== null && c(e)
                } finally {
                    r(),
    ...
    Fp.prototype.addEventListener = function(e, t, n) {
        var r = null
          , i = null;
        if (!(n != null && typeof n != `boolean` && (r = n.signal || null,
        r !== null && r.aborted))) {
            ...
            if (Bp(a, e, t, n) === -1) {
                ...
                r !== null && (i = o.removeEventListener.bind(o, e, t, n),
    ...
    ;
    function Ip(e, t, n, r) {
        return b(e).addEventListener(t, n, r),
        !1
    }
    Fp.prototype.removeEventListener = function(e, t, n) {
        var r = this._eventListeners;
        if (r !== null && (t = Bp(r, e, t, n),
        t !== -1)) {
            var i = r[t];
    ...
    ;
    function Lp(e, t, n, r) {
        return b(e).removeEventListener(t, n, r),
        !1
    }
    function Rp(e) {
    ...
    Fp.prototype.unobserveUsing = function(e) {
        ...
        if (t !== null && t.has(e)) {
            t.delete(e),
            h(this._fragmentFiber.child, !1, Gp, e, void 0, void 0);
    ...
    Fp.prototype.getClientRects = function() {
        var e = [];
        return h(this._fragmentFiber.child, !1, Yp, e, void 0, void 0),
        e
    }
    ;
    function Yp(e, t) {
    ...
    Fp.prototype.compareDocumentPosition = function(e) {
        ...
        if (n.length === 0) {
            ...
            return n === e ? i = Node.DOCUMENT_POSITION_CONTAINS : r & Node.DOCUMENT_POSITION_CONTAINED_BY && (n = v(t)[1],
            n === null ? i = Node.DOCUMENT_POSITION_PRECEDING : (e = b(n).compareDocumentPosition(e),
            i = e === 0 || e & Node.DOCUMENT_POSITION_FOLLOWING ? Node.DOCUMENT_POSITION_FOLLOWING : Node.DOCUMENT_POSITION_PRECEDING)),
        ...
        return s = r && a && o & Node.DOCUMENT_POSITION_FOLLOWING && s & Node.DOCUMENT_POSITION_PRECEDING,
        t = r && t === e || a && i === e || c || s ? Node.DOCUMENT_POSITION_CONTAINED_BY : !r && t === e || !a && i === e ? Node.DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC : o,
        t & Node.DOCUMENT_POSITION_DISCONNECTED || t & Node.DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC || Xp(t, this._fragmentFiber, n[0], n[n.length - 1], e) ? t : Node.DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC
    }
    ;
    function Xp(e, t, n, r, i) {
        ...
        return e & Node.DOCUMENT_POSITION_PRECEDING ? ((t = !!a) && !(t = a === n) && (t = re(n, a, S),
        t === null ? t = !1 : (h(t, !0, te, a, n),
        a = x,
        x = null,
        t = a !== null)),
        t) : e & Node.DOCUMENT_POSITION_FOLLOWING ? ((t = !!a) && !(t = a === r) && (t = re(r, a, S),
        t === null ? t = !1 : (h(t, !0, ne, a, r),
        a = x,
        ee = x = null,
        t = a !== null)),
        t) : !1
    ...
    Fp.prototype.scrollIntoView = function(e) {
        ...
        if (t.length === 0) {
            ...
            if (r = n ? r[1] || r[0] || g(this._fragmentFiber) : r[0] || r[1],
            r === null)
                return;
            if (r.tag === 6) {
                e = b(r),
    ...
    function im(e, t, n) {
        if (t === ``)
            return null;
        for (; e.nodeType !== 3; )
            if ((e.nodeType !== 1 || e.nodeName !== `INPUT` || e.type !== `hidden`) && !n || (e = lm(e.nextSibling),
            e === null))
                return null;
        return e
    }
    function am(e, t) {
        for (; e.nodeType !== 8; )
            if ((e.nodeType !== 1 || e.nodeName !== `INPUT` || e.type !== `hidden`) && !t || (e = lm(e.nextSibling),
            e === null))
                return null;
        return e
    }
    ...
    function Om(e, t, n) {
        ...
        if (r && e && t) {
            ...
            t === `image` && n && n.imageSrcSet ? (i += `[imagesrcset="` + un(n.imageSrcSet) + `"]`,
            typeof n.imageSizes == `string` && (i += `[imagesizes="` + un(n.imageSizes) + `"]`)) : i += `[href="` + un(e) + `"]`;
            var a = i;
            switch (t) {
            case `style`:
                a = Pm(e);
            ...
            vm.set(a, e),
            r.querySelector(i) !== null || t === `style` && r.querySelector(Fm(a)) || t === `script` && r.querySelector(zm(a))))) {
    ...
    function km(e, t) {
        ...
        if (n && e) {
            var r = t && typeof t.as == `string` ? t.as : `script`
              , i = `link[rel="modulepreload"][as="` + un(r) + `"][href="` + un(e) + `"]`
              , a = i;
            switch (r) {
            case `audioworklet`:
            case `paintworklet`:
    ...
    function Nm(e, t, n, r) {
        ...
        case `title`:
            return null;
        case `style`:
            return typeof n.precedence == `string` && typeof n.href == `string` ? (n = Pm(n.href),
            t = Ut(a).hoistableStyles,
            r = t.get(n),
            r || (r = {
                type: `style`,
                instance: null,
        ...
        case `link`:
            if (n.rel === `stylesheet` && typeof n.href == `string` && typeof n.precedence == `string`) {
                ...
                o.set(e, s),
                (o = a.querySelector(Fm(e))) ? o._p || (s.instance = o,
                s.state.loading = 5) : (o = vm.get(e),
                o || (o = {
                    rel: `preload`,
                    as: `style`,
                    href: n.href,
        ...
        case `script`:
            return t = n.async,
            n = n.src,
            typeof n == `string` && t && typeof t != `function` && typeof t != `symbol` ? (n = Rm(n),
            t = Ut(a).hoistableScripts,
            r = t.get(n),
            r || (r = {
                type: `script`,
                instance: null,
    ...
    function Bm(e, t, n) {
        ...
        t.instance === null)
            ...
            case `script`:
                return o = Rm(n.src),
                (a = e.querySelector(zm(o))) ? (t.instance = a,
                j(a),
                a) : (r = n,
                (a = vm.get(o)) && (r = C({}, n),
                Um(r, a)),
    ...
    var $m = 0;
    function eh(e, t) {
        return e.stylesheets && e.count === 0 && ah(e, e.stylesheets),
        0 < e.count || 0 < e.imgCount ? function(n) {
            ...
            var i = setTimeout(function() {
                ...
                e.count === 0 && (e.stylesheets && ah(e, e.stylesheets),
                e.unsuspend)) {
                    var t = e.unsuspend;
                    e.unsuspend = null,
                    t()
    ...
    function lh(e, t, n, r, i, a, o, s, c, l, u, d) {
        return e = new ch(e,t,n,o,c,l,u,d,s),
        t = 1,
        !0 === a && (t |= 24),
        a = Li(3, null, null, t),
        e.current = a,
    ...
    var wh = !1
      ...
      , kh = new Map
      , Ah = []
      , jh = `mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset`.split(` `);
    function Mh(e, t) {
        switch (e) {
        case `focusin`:
        case `focusout`:
    ...
    function Ph(e, t, n, r, i) {
        switch (t) {
        case `focusin`:
            return Th = Nh(Th, e, t, n, r, i),
            !0;
        case `dragenter`:
            return Eh = Nh(Eh, e, t, n, r, i),
            !0;
        case `mouseover`:
            return Dh = Nh(Dh, e, t, n, r, i),
            !0;
        case `pointerover`:
            var a = i.pointerId;
            return Oh.set(a, Nh(Oh.get(a) || null, e, t, n, r, i)),
            !0;
        case `gotpointercapture`:
    ...
    function Hh(e) {
        ...
        for (; 0 < Ah.length && (n = Ah[0],
        n.blockedOn === null); )
            Fh(n),
            n.blockedOn === null && Ah.shift();
...
function le(e, t, n, r={}) {
    ...
    function f(e, t) {
        s = `PUSH`;
        let r = re(e) ? e : oe(h.location, e, t);
        n && n(r, e),
        l = u() + 1;
        let d = ae(r, l)
...
function fe(e, t, n, r, i) {
    let a = O((typeof t == `string` ? ce(t) : t).pathname || `/`, n);
    if (a == null)
        return null;
    let o = i ?? pe(e)
      , s = null
...
function ge(e) {
    e.sort( (e, t) => e.score === t.score ? E(e.routesMeta.map(e => e.childrenIndex), t.routesMeta.map(e => e.childrenIndex)) : t.score - e.score)
}
var _e = /^:[\w-]+$/
  , ve = 3
  , ye = 2
...
function we(e, t) {
    let n = e.split(`/`)
      , r = n.length;
    return n.some(Ce) && (r += Se),
    t && (r += ye),
    n.filter(e => !Ce(e)).reduce( (e, t) => e + (_e.test(t) ? ve : t === `` ? be : xe), r)
}
function E(e, t) {
...
function D(e, t, n=!1) {
    ...
    for (let e = 0; e < r.length; ++e) {
        let s = r[e]
          ...
          , d = s.matcher && s.compiledParams ? Ee(u, l, s.matcher, s.compiledParams) : Te(u, l)
          , f = s.route;
        if (!d && c && n && !r[r.length - 1].route.index && (d = Te({
            path: s.relativePath,
            caseSensitive: s.caseSensitive,
            end: !1
        }, l)),
...
function Ee(e, t, n, r) {
    ...
    return {
        params: r.reduce( (e, {paramName: t, isOptional: n}, r) => {
            ...
            let i = s[r];
            return e[t] = n && !i ? void 0 : (i || ``).replace(/%2F/g, `/`),
            e
        }
        , {}),
        pathname: a,
...
function k(e, t=`/`) {
    let {pathname: n, search: r=``, hash: i=``} = typeof e == `string` ? ce(e) : e, a;
    return n ? (n = Pe(n),
    a = n.startsWith(`/`) || n.startsWith(`\\`) ? ke(n.substring(1), `/`) : ke(n, t)) : a = t,
    {
        pathname: a,
        search: Re(r),
        hash: ze(i)
...
function Ne(e, t, n, r=!1) {
    let i;
    typeof e == `string` ? i = ce(e) : (i = {
        ...e
    },
    w(!i.pathname || !i.pathname.includes(`?`), Ae(`?`, `pathname`, `search`, i)),
    w(!i.pathname || !i.pathname.includes(`#`), Ae(`#`, `pathname`, `hash`, i)),
...
function Ie(e, t=0) {
    let n = e.length;
    for (; n > t && e.charCodeAt(n - 1) === 47; )
        n--;
    return n === e.length ? e : e.slice(0, n)
}
var Le = e => Ie(e).replace(/^\/*/, `/`)
    ...
    if (Ue)
        try {
            let e = new URL(window.location.href)
              , r = te.test(n) ? new URL(ne(n, e.protocol)) : new URL(n)
              , a = O(r.pathname, t);
...
function Ye(e, t, n, r) {
    ...
    } else if (s && (i == null || !Je(e, i) || !qe(i, a)))
        throw Error(`External navigation is not allowed`)
}
...
function ht(e, {relative: t}={}) {
    w(gt(), `useHref() may be used only in the context of a <Router> component.`);
    let {basename: n, navigator: r} = x.useContext(A)
      , {hash: i, pathname: a, search: o} = Ct(e, {
        relative: t
    })
      , s = a;
    return n !== `/` && (s = a === `/` ? n : Fe([n, a])),
    r.createHref({
        pathname: s,
        search: o,
        hash: i
...
function _t() {
    return w(gt(), `useLocation() may be used only in the context of a <Router> component.`),
    x.useContext(st).location
}
var vt = `You should call navigate() in a React.useEffect(), not when your component is first rendered.`;
function yt(e) {
    x.useContext(A).static || x.useLayoutEffect(e)
}
function bt() {
...
function xt() {
    w(gt(), `useNavigate() may be used only in the context of a <Router> component.`);
    let e = x.useContext(et)
      , {basename: t, navigator: n} = x.useContext(A)
    ...
    x.useCallback( (r, s={}) => {
        ...
        e == null && t !== `/` && (c.pathname = c.pathname === `/` ? t : Fe([t, c.pathname])),
        Ye(typeof r == `string` ? r : se(r), n.createHref(c), Ke(n), `reject`),
...
function Tt(e, t, n) {
    w(gt(), `useRoutes() may be used only in the context of a <Router> component.`);
    let {navigator: r} = x.useContext(A)
...
Please change the parent <Route path="${e}"> to <Route path="${e === `/` ? `*` : `${e}/*`}">.`)
    ...
    T(m == null || m[m.length - 1].route.element !== void 0 || m[m.length - 1].route.Component !== void 0 || m[m.length - 1].route.lazy !== void 0, `Matched leaf route at location "${d.pathname}${d.search}${d.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);
    let h = Mt(m && m.map(e => Object.assign({}, e, {
    ...
    return t && h ? x.createElement(st.Provider, {
        value: {
            location: {
                pathname: `/`,
                search: ``,
...
var Dt = x.createElement(Et, null)
  , Ot = class extends x.Component {
    constructor(e) {
        super(e),
        this.state = {
            location: e.location,
    ...
    render() {
        ...
        let t = e === void 0 ? this.props.children : x.createElement(ct.Provider, {
            value: this.props.routeContext
        }, x.createElement(lt.Provider, {
            value: e,
            children: this.props.component
        }));
        return this.context ? x.createElement(At, {
            error: e
        }, t) : t
    }
}
...
function At({children: e, error: t}) {
    ...
    if (typeof t == `object` && t && `digest` in t && typeof t.digest == `string`) {
        ...
        if (e) {
            ...
            if (i)
                throw i;
            let a = We(e.location, n)
              , o = a.absoluteURL || a.to;
            if (Ye(e.location, o, Ke(r), `allow-explicit`),
            $e(o))
...
function Mt(e, t=[], n) {
    ...
    if (a != null) {
        ...
        w(e >= 0, `Could not find a matching route for errors on route IDs: ${Object.keys(a).join(`,`)}`),
    ...
    return i.reduceRight( (e, n, c) => {
        ...
        o && (s < 0 && c === 0 ? (Ht(`route-fallback`, !1, "No `HydrateFallback` element provided to render during initial hydration"),
        d = !0,
        p = null) : s === c && (d = !0,
        ...
        ;
        return r && (n.route.ErrorBoundary || n.route.errorElement || c === 0) ? x.createElement(Ot, {
            location: r.location,
...
function Wt({basename: e=`/`, children: t=null, location: n, navigationType: r=`POP`, navigator: i, static: a=!1, useTransitions: o}) {
    w(!gt(), `You cannot render a <Router> inside another <Router>. You should never have more than one in your app.`);
    let s = e.replace(/^\/*/, `/`)
      , c = x.useMemo( () => ({
        basename: s,
        navigator: i,
    ...
    , [s, l, u, d, f, p, r, m]);
    return T(h != null, `<Router basename="${s}"> is not able to match the URL "${l}${u}${d}" because it does not start with the basename, so the <Router> won't render anything.`),
    h == null ? null : x.createElement(A.Provider, {
        value: c
...
function Kt(e, t=[]) {
    let n = [];
    return x.Children.forEach(e, (e, r) => {
        ...
        e.props.children && (a.children = Kt(e.props.children, i)),
        n.push(a)
    }
    ),
    n
...
function on(e) {
    return e != null && !an.has(e) ? (T(!1, `"${e}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Jt}"`),
    null) : e
}
function sn(e, t) {
    let n, r, i, a, o;
    if (Zt(e)) {
        ...
        i = on(e.getAttribute(`enctype`)) || Jt,
        a = new FormData(e)
        ...
        i = on(e.getAttribute(`formenctype`)) || on(o.getAttribute(`enctype`)) || Jt,
        a = new FormData(o,e),
        !rn()) {
...
function ln(e, t, n, r) {
    ...
    return i.pathname = n ? i.pathname.endsWith(`/`) ? `${i.pathname}_.${r}` : `${i.pathname}.${r}` : i.pathname === `/` ? `_root.${r}` : t && O(i.pathname, t) === `/` ? `${Ie(t)}/_root.${r}` : `${Ie(i.pathname)}.${r}`,
    i
}
...
async function pn(e, t, n) {
    return vn((await Promise.all(e.map(async e => {
    ...
    ))).flat(1).filter(fn).filter(e => e.rel === `stylesheet` || e.rel === `preload`).map(e => e.rel === `stylesheet` ? {
        ...e,
        rel: `prefetch`,
        as: `style`
    } : {
...
function vn(e, t) {
    let n = new Set
      , r = new Set(t);
    return e.reduce( (e, i) => {
        if (t && !dn(i) && i.as === `script` && i.href && r.has(i.href))
            return e;
...
function yn() {
    let e = x.useContext(et);
    return cn(e, `You must render this element inside a <DataRouterContext.Provider> element`),
    e
}
function bn() {
    let e = x.useContext(tt);
    return cn(e, `You must render this element inside a <DataRouterStateContext.Provider> element`),
    e
}
...
function Sn() {
    ...
    return cn(e, `You must render this element inside a <HydratedRouter> element`),
    e
}
function Cn(e, t) {
...
function Tn({page: e, ...t}) {
    let n = rt()
      , {nonce: r} = Sn()
      , {router: i} = yn()
      , a = x.useMemo( () => de(i.routes, e, i.basename), [i.routes, e, i.basename]);
    return a ? (t.nonce == null && r && (t = {
        ...t,
        nonce: r
    }),
    n ? x.createElement(Dn, {
        page: e,
        matches: a,
        ...t
    }) : x.createElement(On, {
...
try {
    An && (window.__reactRouterVersion = `7.18.3`)
} catch {}
function jn({basename: e, children: t, useTransitions: n, window: r}) {
    ...
    , [n]);
    return x.useLayoutEffect( () => a.listen(c), [a, c]),
    x.createElement(Wt, {
        basename: e,
        children: t,
        location: o.location,
...
var Mn = x.forwardRef(function({onClick: e, discover: t=`render`, prefetch: n=`none`, relative: r, reloadDocument: i, replace: a, mask: o, state: s, target: c, to: l, preventScrollReset: u, viewTransition: d, defaultShouldRevalidate: f, ...p}, m) {
    let {basename: h, navigator: g, useTransitions: _} = x.useContext(A)
    ...
    let b = ht(l, {
      ...
      , ne = null;
    if (o) {
        let e = Ne(o, [], te.mask ? te.mask.pathname : `/`, !0);
        h !== `/` && (e.pathname = e.pathname === `/` ? h : Fe([h, e.pathname])),
        ne = g.createHref(e)
    }
    let[S,re,C] = Cn(n, p)
      , w = Ln(l, {
    ...
    function T(t) {
        e && e(t),
        t.defaultPrevented || w(t)
    }
    let ie = !(y.isExternal || i)
      , ae = x.createElement(`a`, {
        ...p,
        ...C,
        href: (ie ? ne : void 0) || y.absoluteURL || b,
        onClick: ie ? T : e,
        ref: kn(m, re),
        target: c,
        "data-discover": !v && t === `render` ? `true` : void 0
    });
    return S && !v ? x.createElement(x.Fragment, null, ae, x.createElement(Tn, {
        page: b
    })) : ae
});
Mn.displayName = `Link`;
var Nn = x.forwardRef(function({"aria-current": e=`page`, caseSensitive: t=!1, className: n=``, end: r=!1, style: i, to: a, viewTransition: o, children: s, ...c}, l) {
    let u = Ct(a, {
        relative: c.relative
    })
      , d = _t()
      , f = x.useContext(tt)
      , {navigator: p, basename: m} = x.useContext(A)
      , h = f != null && Un(u) && o === !0
    ...
    g = g.toLowerCase()),
    v && m && (v = O(v, m) || v);
    let y = g !== `/` && g.endsWith(`/`) ? g.length - 1 : g.length, b = _ === g || !r && _.startsWith(g) && _.charAt(y) === `/`, ee = v != null && (v === g || !r && v.startsWith(g) && v.charAt(g.length) === `/`), te = {
        isActive: b,
        isPending: ee,
        isTransitioning: h
    }, ne = b ? e : void 0, S;
    S = typeof n == `function` ? n(te) : [n, b ? `active` : null, ee ? `pending` : null, h ? `transitioning` : null].filter(Boolean).join(` `);
...
var Pn = x.forwardRef( ({discover: e=`render`, fetcherKey: t, navigate: n, reloadDocument: r, replace: i, state: a, method: o=qt, action: s, onSubmit: c, relative: l, preventScrollReset: u, viewTransition: d, defaultShouldRevalidate: f, ...p}, m) => {
    let {useTransitions: h} = x.useContext(A)
      , g = Vn()
      , _ = Hn(s, {
        relative: l
    })
...
function Rn(e) {
    ...
    let t = x.useRef(en(e))
      , n = x.useRef(!1)
      , r = _t()
      , i = x.useMemo( () => tn(r.search, n.current ? null : t.current), [r.search])
      , a = bt();
    return [i, x.useCallback( (e, t) => {
        let r = en(typeof e == `function` ? e(new URLSearchParams(i)) : e);
        n.current = !0,
        a(`?` + r, t)
    }
    , [a, i])]
...
function Hn(e, {relative: t}={}) {
    ...
    n !== `/` && (a.pathname = a.pathname === `/` ? n : Fe([n, a.pathname])),
    se(a)
}
function Un(e, {relative: t}={}) {
    let n = x.useContext(it);
...
async function qn(e, t=20) {
    ...
    if (!n.ok)
        throw Error(`catalog ${n.status}`);
    return n.json()
}
async function Jn(e) {
    let t = await fetch(`/api/product/${e}`);
    if (!t.ok)
        throw Error(`product ${t.status}`);
    return t.json()
}
async function Yn() {
    let e = await fetch(`/api/layout`);
    if (!e.ok)
        throw Error(`layout ${e.status}`);
    return e.json()
}
function Xn(e) {
    return () => {
...
var Zn = o((e => {
  ...
  , $n = {
    ...
    N.jsxs)(N.Fragment, {
        ...
        N.jsx)(`path`, {
            d: `M9 7l.4-3h5.2L15 7M9 17l.4 3h5.2l.4-3`
        }), (0,
        N.jsx)(`path`, {
            d: `M12 10v2l1.5 1`
        })]
    ...
    N.jsxs)(N.Fragment, {
        children: [(0,
        N.jsx)(`path`, {
            d: `M3 10l9-7 9 7v10a1.5 1.5 0 0 1-1.5 1.5H4.5A1.5 1.5 0 0 1 3 20z`
        }), (0,
        N.jsx)(`path`, {
            d: `M9.5 21v-6h5v6`
        })]
    ...
    N.jsxs)(N.Fragment, {
        children: [(0,
        N.jsx)(`path`, {
            d: `M6 8V6a3 3 0 0 1 6 0M9 8V6a3 3 0 0 1 6 0v2`
        }), (0,
        N.jsx)(`path`, {
            d: `M4.5 8h15l-1 12.5A1.5 1.5 0 0 1 17 22H7a1.5 1.5 0 0 1-1.5-1.5z`
        })]
    }),
    Kitchen: (0,
    N.jsxs)(N.Fragment, {
        children: [(0,
        N.jsx)(`path`, {
            d: `M18 8h1.5a3 3 0 0 1 0 6H18`
        }), (0,
        N.jsx)(`path`, {
            d: `M4 8h14v8a4 4 0 0 1-4 4H8a4 4 0 0 1-4-4z`
        }), (0,
        N.jsx)(`path`, {
            d: `M8 3v2M12 3v2`
        })]
    ...
    N.jsxs)(N.Fragment, {
        children: [(0,
        N.jsx)(`path`, {
            d: `M2 16c0-2 .8-3.4 2.4-4.4L7 14l2.5-5c1.6 1.7 4 2.6 7.5 2.8 2.2.1 4 1.7 4.5 3.7l.3 1.7`
        }), (0,
        N.jsx)(`path`, {
            d: `M2 16v2.5A1.5 1.5 0 0 0 3.5 20h17a1.5 1.5 0 0 0 1.5-1.5V16`
        })]
    })
};
function er({category: e}) {
    let t = $n[e] ?? (0,
    N.jsx)(`rect`, {
        x: `4`,
        y: `4`,
...
function nr({page: e, pages: t, onChange: n}) {
    return t <= 1 ? null : (0,
    N.jsxs)(`nav`, {
...
function rr() {
    let[e,t] = Rn()
      , n = Math.max(1, Number(e.get(`page`)) || 1)
      , r = e => t({
        page: String(e)
    })
      , [i,a] = (0,
    ...
    N.jsxs)(`section`, {
        ...
        children: [(0,
        N.jsxs)(`div`, {
            className: `browse-intro`,
            children: [(0,
            N.jsx)(`h1`, {
                children: `All products`
            }), (0,
            N.jsxs)(`p`, {
                children: [i ? `${i.total} products` : `Loading…`, ` · browse the shelves. Prices are shown on each product’s page.`]
            })]
        }), c && (0,
        N.jsx)(`div`, {
        ...
        N.jsxs)(`div`, {
            className: `grid-empty grid-error`,
            children: [`Couldn’t load products: `, o]
        }), i && !c && (0,
        N.jsxs)(N.Fragment, {
            children: [(0,
            N.jsx)(`div`, {
                className: `grid`,
                children: i.items.map(e => (0,
                N.jsx)(tr, {
                    product: e
                }, e.id))
            }), (0,
...
function ar() {
    try {
        ...
        if (!t)
            return ``;
        let n = t.createLinearGradient(0, 0, 220, 60);
        return n.addColorStop(0, `#2b6cb0`),
        n.addColorStop(1, `#f6ad55`),
        t.fillStyle = n,
        t.fillRect(0, 0, 220, 60),
        t.font = `17px "Times New Roman", serif`,
        t.fillStyle = `rgba(12,30,60,0.87)`,
        t.fillText(`INE store ✓ price ₹ 42.9`, 6, 38),
        t.arc(170, 30, 18, 0, Math.PI * 1.5),
        t.stroke(),
        ir(e.toDataURL())
    } catch {
        return ``
...
function or() {
    try {
        ...
        return ir(`${n ? t.getParameter(n.UNMASKED_VENDOR_WEBGL) : t.getParameter(t.VENDOR)}|${n ? t.getParameter(n.UNMASKED_RENDERER_WEBGL) : t.getParameter(t.RENDERER)}|${t.getParameter(t.VERSION)}`)
    } catch {
        return ir(`gl-error`)
    }
}
function sr(e) {
    return new Promise(t => {
        let n = []
          , r = -1
          , i = a => {
            if (r >= 0 && n.push(Math.round((a - r) * 100) / 100),
            r = a,
            n.length >= e)
                return t(n);
...
(function(e, t) {
    ...
    for (; ; )
        try {
            if (-parseInt(n(494)) / 1 * (parseInt(n(537)) / 2) + parseInt(n(559)) / 3 + parseInt(n(503)) / 4 * (parseInt(n(589)) / 5) + -parseInt(n(583)) / 6 * (-parseInt(n(529)) / 7) + -parseInt(n(505)) / 8 + -parseInt(n(593)) / 9 + parseInt(n(564)) / 10 * (parseInt(n(502)) / 11) === t)
                break;
            r.push(r.shift())
        } catch {
            r.push(r.shift())
...
function fr(e) {
    let t = P
      , n = {
        ...
        APuvv: function(e, t, n) {
            return e(t, n)
        },
        gIqgS: function(e, t, n) {
            return e(t, n)
        },
        wXrIu: function(e, t) {
            return e - t
    ...
    let y = new Uint8Array(32)
      , b = new DataView(y[t(534)]);
    return [r, i, a, o, s, c, l, u][t(499) + `h`]( (e, n) => b[t(545) + t(603)](n * 4, e >>> 0, !1)),
    y
}
function pr(e, t) {
    e -= 486;
    ...
    pr.Azkpgu === void 0 && (pr.kahTKp = function(e) {
        let t = ``
          , n = ``;
        for (let n = 0, r, i, a = 0; i = e.charAt(a++); ~i && (r = n % 4 ? r * 64 + i : i,
        n++ % 4) && (t += String.fromCharCode(255 & r >> (-2 * n & 6))))
...
function _r(e) {
    ...
    for (let e = 0; n[t(601)](e, r[t(553)]); e++)
        i[e] = r[t(557) + t(522)](e);
    return i
}
function vr() {
...
function xr(e, t) {
    let n = P
      ...
      , i = `0`[n(598)](t)
      , a = 0;
    for (; r[n(562)](gr, e + `:` + a)[n(512)](0, t) !== i; )
        a++;
    return a
}
function Sr(e) {
    let t = P
      ...
      , r = n[t(487)](atob, e)
      , i = new Uint8Array(r[t(553)]);
    for (let e = 0; n[t(521)](e, r[t(553)]); e++)
        i[e] = r[t(557) + t(522)](e);
    return i
}
...
function wr(e, t) {
    ...
    for (let e = 0; r[n(574)](e, a[n(553)]); e++)
        o[e] = a[e] ^ i[r[n(504)](e, i[n(553)])];
...
async function Dr(e, t) {
    ...
    if (!i.ok)
        throw new Er(i[n(565)]);
    let a = await i[n(519)]()
      , o = await r[n(532)](cr, t)
      , s = gr(o)
      , c = await Cr(a[n(500)], br(a[n(568)], s))
      , l = xr(a[n(568)], a[n(558) + n(495)])
      , u = r[n(549)](yr, a[n(568)], c, s)
      , d = {
        ...a
    };
    d[n(520)] = l,
    ...
    if (r[n(525)](f[n(565)], 429))
        throw new Er(429);
    if (!f.ok)
        throw new Tr(n(599) + n(501) + n(579));
    let {token: p} = await f[n(519)]()
      , m = {};
    m[n(508) + n(551) + `n`] = n(586) + ` ` + p;
    let h = {};
    h[n(576) + `s`] = m;
    let g = await fetch(n(585) + n(523) + `s/` + e + n(526), h);
    if (g[n(565)] === 401 || r[n(488)](g[n(565)], 403))
        throw new Tr(n(591) + n(554));
    if (!g.ok)
        throw new Er(g[n(565)]);
    let _ = await g[n(519)]();
...
var Or = 40
  ...
  , Mr = `​`
  , Nr = `\xA0`
  , Pr = e => new Promise(t => setTimeout(t, e));
function Fr(e, t) {
...
function Ir(e, t, n) {
    ...
    case `spaced`:
        return r.replace(/,/g, ` `);
    case `euro`:
        return `${r.replace(/,/g, `.`)},00`;
    case `trailing`:
        return `${r}/- (incl. of all taxes)`;
    case `unicode`:
        return r.replace(/[0-9]/g, e => String.fromCharCode(65296 + Number(e)));
    case `nbsp`:
        return r.split(``).join(`\xA0​`);
    case `lakh`:
        return `Rs.${Nr}${new Intl.NumberFormat(`en-IN`,{
...
function Lr(e) {
    return e.split(``).map( (t, n) => (0,
    N.jsxs)(`span`, {
        children: [t, n < e.length - 1 ? Mr : ``]
    }, n))
}
var Rr = [e => `In stock · ${e} left`, e => `Only ${e} left`, e => `${e} in stock`, e => `Selling fast — ${e} left`, e => `Hurry, just ${e} left`];
function zr(e) {
...
function Ur({productId: e, layout: t}) {
    let[n,r] = (0,
    x.useState)({
        phase: `idle`,
        attempt: 0
    ...
    , [e, a])
      ...
      , l = e => a.move(e.clientX, e.clientY)
      , u = () => a.enter()
      , d = (0,
    x.useMemo)( () => {
        if (!n.quote)
        ...
        return {
            rot: `v${Vr()}`,
            d1: Fr(Br(e.shown), e.currency),
            d2: Fr(Br(e.shown + 7), e.currency)
        }
    }
    , [n.quote])
      , f = t?.classes
    ...
    if (n.phase === `idle`)
        return (0,
        N.jsxs)(`div`, {
            className: `price-block price-idle ${f?.priceWrap ?? ``}`,
            onMouseMove: l,
            onMouseEnter: u,
            children: [(0,
            N.jsxs)(`div`, {
                ...
                N.jsx)(`p`, {
                    ...
                    children: `Price hidden`
                }), (0,
                N.jsx)(`p`, {
                    className: `price-substatus`,
                    children: p ?? `Check the current price and availability.`
                })]
            }), (0,
            N.jsx)(`button`, {
                type: `button`,
                ...
                disabled: p !== null,
                onClick: c,
                children: `Reveal price`
            })]
        });
    if (n.phase === `loading` || n.phase === `retrying`)
        return (0,
        N.jsxs)(`div`, {
            className: `price-block ${f?.priceWrap ?? ``}`,
            "aria-live": `polite`,
            "aria-busy": `true`,
            children: [(0,
            N.jsx)(`div`, {
            ...
            N.jsxs)(`div`, {
                ...
                N.jsx)(`p`, {
                    className: `price-status`,
                    children: n.phase === `loading` ? `Loading current price…` : `Retrying (attempt ${n.attempt}/${jr})…`
                }), n.phase === `retrying` && (0,
                N.jsxs)(`p`, {
                    className: `price-substatus`,
                    children: [`Store responded with “`, n.message, `”.`]
                })]
            })]
        });
    if (n.phase === `error`)
        return (0,
        N.jsxs)(`div`, {
            className: `price-block price-error ${f?.priceWrap ?? ``}`,
            "aria-live": `assertive`,
            children: [(0,
            N.jsxs)(`p`, {
                className: `price-status`,
                children: [`Couldn’t load the price after `, n.attempt, ` attempts.`]
            }), (0,
            N.jsx)(`p`, {
                className: `price-substatus`,
                children: n.message
    ...
    let m = n.quote
      , h = Ir(m.shown, m.currency, m.format)
      , g = new Date(m.at + m.deliveryDays * 864e5)
      , _ = {
        rating: (0,
        N.jsxs)(`div`, {
            className: f?.rating,
            ...t?.ratingAria ? {
                "aria-label": `Rated ${m.rating} out of 5`
            } : {},
            children: [(0,
            N.jsx)(`span`, {
                style: {
            ...
            N.jsxs)(`small`, {
                children: [Hr(m.ratingCount), ` ratings`]
            })]
        }, `rating`),
        seller: (0,
        N.jsx)(`div`, {
            ...
            N.jsxs)(`small`, {
                children: [`Sold by `, (0,
                N.jsx)(`span`, {
                    children: m.seller.slice(0, 3)
                }), Mr, (0,
                N.jsx)(`span`, {
                    children: m.seller.slice(3)
                })]
            })
        }, `seller`),
        delivery: (0,
        N.jsx)(`div`, {
            className: f?.delivery,
            children: (0,
            N.jsxs)(`small`, {
                children: [`Get it by`, ` `, g.toLocaleDateString(`en-IN`, {
                    weekday: `short`,
                    day: `numeric`,
                    month: `short`
                })]
      ...
      , y = (0,
    N.jsx)(v, {
        className: `${d.rot} ${f?.priceValue ?? ``}`,
        style: {
            fontFamily: `var(--serif)`,
            fontSize: `2.4rem`,
            fontWeight: 700,
            letterSpacing: `-0.02em`,
            opacity: m.pending ? .45 : 1
        },
        children: t?.priceCarrier === `split` ? Lr(h) : h
    });
    return (0,
    N.jsxs)(`div`, {
        className: `price-block price-success ${f?.priceWrap ?? ``}`,
        "aria-live": `polite`,
        onMouseMove: l,
        onMouseEnter: u,
        children: [(0,
        N.jsxs)(`div`, {
            ...
            N.jsx)(`span`, {
                ...
                children: Fr(m.mrp, m.currency)
            }), m.triple && m.sale !== void 0 && (0,
            N.jsxs)(`span`, {
                className: f?.sale,
                style: {
                    opacity: .75,
                ...
                children: [`Deal price `, Fr(m.sale, m.currency)]
            }), y, (0,
            N.jsxs)(`span`, {
                className: f?.badge,
                style: {
        ...
        N.jsx)(`div`, {
            className: `price-facets`,
            children: (t?.order ?? [`rating`, `seller`, `delivery`, `stock`]).map(e => _[e])
        }), (0,
        N.jsxs)(`div`, {
            className: `price-meta`,
            children: [(0,
            N.jsxs)(`span`, {
                children: [`Loaded in `, n.attempt, ` attempt`, n.attempt > 1 ? `s` : ``]
            }), (0,
            N.jsx)(`button`, {
                type: `button`,
                className: `btn btn-ghost btn-sm`,
                onClick: c,
                children: `Refresh price`
            })]
        })]
    })
}
function Wr(e) {
    let t = e.weightGrams >= 1e3 ? `${(e.weightGrams / 1e3).toFixed(2)} kg` : `${e.weightGrams} g`;
    return [[`Warranty`, e.warranty], [`In the box`, e.inTheBox], [`Country of origin`, e.countryOfOrigin], [`Returns`, e.returns], [`Support`, e.support], [`Weight`, t], [`Material`, e.material], [`Colour`, e.colour], [`Model year`, String(e.modelYear)]]
}
function Gr({rating: e}) {
    return (0,
    N.jsxs)(`span`, {
        className: `review-stars`,
        "aria-label": `${e} out of 5`,
        children: [`★`.repeat(e), (0,
        N.jsx)(`span`, {
            className: `review-stars-off`,
            children: `★`.repeat(5 - e)
        })]
    })
}
function Kr() {
    ...
    x.useEffect)( () => {
        ...
        return r(null),
        s(null),
        Jn(t).then(t => e && r(t)).catch(t => e && s(String(t))),
        Yn().then(t => e && a(t)).catch( () => void 0),
        () => {
            e = !1
        }
    }
    ...
    N.jsxs)(`section`, {
        ...
        N.jsxs)(`div`, {
            className: `grid-empty grid-error`,
            children: [`Couldn’t load this product: `, o]
        }), n && (0,
        N.jsxs)(N.Fragment, {
            children: [(0,
            N.jsxs)(`div`, {
            ...
            N.jsxs)(`div`, {
                ...
                N.jsxs)(`p`, {
                    children: [`The `, n.name, ` is part of our everyday `, n.category.toLowerCase(), ` range. It is built around the features people actually reach for, without the ones they never use, and it is designed to keep working after the novelty wears off.`]
                }), (0,
                N.jsx)(`p`, {
                    children: `Pricing and availability on this page are live and can change during the day. The figure shown is the current selling price for this listing; taxes are included where applicable.`
                }), (0,
                N.jsx)(`h2`, {
                ...
                N.jsx)(`ul`, {
                    ...
                    N.jsxs)(`li`, {
                        ...
                        N.jsxs)(`p`, {
                            ...
                            children: [e.author, ` · `, e.date, e.verifiedPurchase && (0,
                            N.jsx)(`span`, {
                        ...
                        N.jsxs)(`p`, {
                            ...
                            children: [e.helpfulVotes, ` people found this helpful`]
                        })]
                    }, e.id))
                }), (0,
                N.jsx)(`p`, {
                    className: `detail-fineprint`,
                    children: `Delivery estimates assume a serviceable pincode and in-stock inventory at the nearest hub. The review list is the full history for this listing; the rating shown beside the price is the current aggregate and is recalculated far more often.`
                })]
            })]
        })]
    })
}
var qr = [`bottom`, `top`, `center`];
function Jr() {
    let e = Math.random();
    return e < .7 ? 1 : e < .95 ? 2 : 3
}
function Yr() {
    let[e,t] = (0,
    x.useState)(!1)
    ...
    x.useEffect)( () => {
        if (Math.random() > .75)
            return;
        r(qr[Math.floor(Math.random() * qr.length)]),
        i.current = Jr();
        let e = Gn + Math.random() * (Kn - Gn)
          , n = window.setTimeout( () => t(!0), e);
    ...
    x.useCallback)(e => {
        if (e.key !== `Tab`)
            return;
        let t = a.current?.querySelectorAll(`button`);
        if (!t || t.length === 0)
            return;
        let n = t[0]
          , r = t[t.length - 1];
    ...
    N.jsx)(`div`, {
        ...
        N.jsxs)(`div`, {
            ref: a,
            className: `cookie-banner cookie-${n}`,
            role: `dialog`,
            "aria-modal": `true`,
            ...
            N.jsx)(`p`, {
                ...
                children: `We use cookies to make this store work and to remember your preferences. By continuing to browse you accept our use of cookies.`
            }), (0,
            N.jsxs)(`div`, {
...
function Xr() {
    ...
    N.jsxs)(`div`, {
        ...
        N.jsxs)(`header`, {
            ...
            N.jsx)(`span`, {
                className: `tagline`,
                children: `Everyday goods, honestly priced.`
            })]
        }), (0,
        N.jsx)(`main`, {
            className: `site-main`,
        ...
        N.jsx)(`footer`, {
            ...
            children: `Demo storefront. All products, brands, and prices are fictional.`
        }), (0,
        N.jsx)(Yr, {})]
    })
}
(0,
Wn.createRoot)(document.getElementById(`root`)).render((0,
N.jsx)(x.StrictMode, {
    children: (0,
    N.jsx)(jn, {
        children: (0,
